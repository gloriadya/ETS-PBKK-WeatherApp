...
namespace WeatherApp
{
    public partial class Form1 : Form
    {
        ...
        string APIKey = "cde7ea1104217f7b72b1150e6902bf56";
        ...
        private void getWeather()
        {
            ...
            {
                string url = string.Format("https://api.openweathermap.org/data/2.5/weather?q=Surabaya&appid=cde7ea1104217f7b72b1150e6902bf56", pic_icon.Text, APIKey);
                ...
                lab_windspeend.Text = Info.wind.speed.ToString();
